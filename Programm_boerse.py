...
def predict_stock_data(bounded_data_dict):
    ...
    #model.add(keras.layers.Dense(units = train_data_length), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/2), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length), activation='relu'))
    ...
    #model.add(keras.layers.Dense(units = train_data_length/2), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/4), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/8), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/16), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/32), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/64), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/128), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/256), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
    #model.add(keras.layers.Dense(units = train_data_length/512), activation='relu'))
    #model.add(keras.layers.Dropout(standard_dropout_factor))
